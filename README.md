...
<script src="./node_modules/ckeditor5-build-integration/build/ckeditor.js"></script>
<script>
	ClassicEditor
...
```js
import ClassicEditor from 'ckeditor5-build-integration';

// Or using the CommonJS version:
// const ClassicEditor = require( 'ckeditor5-build-integration' );
